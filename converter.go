...
func startConverting(logName string, format string, resultChan chan *models.LogModel) {
...
func processLine(logName string, line string, format string, lineNumber uint64) (model *models.LogModel, err error) {
