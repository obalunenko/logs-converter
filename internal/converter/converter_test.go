...
var tests = []test{
	...
	{
		id: 5,
		description: "Negative case. Format missmatch - time format is second, " +
			"but in config specified that file has first",
		input: input{
			logName:    "test",
			line:       `2018-02-01T15:04:05Z | This is log message`,
			format:     "first_format",
	...
	{
		id: 7,
		description: "Negative case. Format missmatch - time format is first, " +
			"but in config specified that file has second",
		input: input{
			logName:    "test",
			line:       `Feb 1, 2018 at 3:04:05pm (UTC) | This is log message`,
			format:     "second_format",
